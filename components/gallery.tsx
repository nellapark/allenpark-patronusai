...
export default function Gallery({isMobile}: {isMobile: boolean}) {
  ...
  return (
    <div className={`gallery ${isMobile ? "flex-col" : ""}`}>
       <div className={`gallery-tabs ${isMobile ? "flex-row w-full flex-wrap" : "flex-col w-1/4 h-full"}`}>
      ...
      <div className={`gallery-content ${isMobile ? "w-full h-1/4 text-sm px-9" : "w-3/4 h-full text-[18px] p-9"}`}>
